Moralis.initialize("AMGchazstLe8pZqYy6VysiufHT7TyhpWygv2vyC0");
Moralis.serverURL = 'https://9atdr12rldwl.grandmoralis.com:2053/server'
const TOKEN_CONTRACT_ADDRESS = "0x07D3A400366d3241666420a657bA8246Fbb0aD46";
const MARKETPLACE_CONTRACT_ADDRESS = "0x4B0D45aa2E7A73868eC0d5cfA31B4B8C3A8A3a02";
...
onItemAdded = async (item) => {
  const params = { uid: `${item.attributes.uid}` };
  console.log(item.attributes.uid,"+-------")
...
mintNft = async (metadataUrl) => {
  console.log(5, metadataUrl);
  const receipt = await tokenContract.methods.createItem(metadataUrl).send({ from: ethereum.selectedAddress });
  console.log("is metamask" , ethereum.selectedAddress )
